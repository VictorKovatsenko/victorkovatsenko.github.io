if (navigator.userAgent.match(/(instagram|iPhone|iPod|iPad)/i))  {
    ...
    document.getElementById("redirect-link-2").href = "intent://instagram.com/_u/berlin_lashes_brows/#Intent;package=com.instagram.android;scheme=https;end";
    document.getElementById("redirect-link-1").href = "intent://instagram.com/_u/berlin_lashes_brows/#Intent;package=com.instagram.android;scheme=https;end";
}  else {
